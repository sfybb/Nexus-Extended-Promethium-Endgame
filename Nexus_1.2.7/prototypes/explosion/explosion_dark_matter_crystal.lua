--explosion_dark_matter_crystal.lua

local explosionEffect = table.deepcopy(data.raw.explosion["nuke-explosion"])
...
explosionEffect.name = "dark-matter-crystal-explosion"
explosionEffect.localised_name = { "entity-name.dark-matter-crystal-explosion" }
...
data.raw.item["dark-matter-crystal"].spoil_ticks = 0.8 * minute
data.raw.item["dark-matter-crystal"].spoil_to_trigger_result = {
  items_per_trigger = 1,
  trigger = {
      type = "direct",
      action_delivery =
