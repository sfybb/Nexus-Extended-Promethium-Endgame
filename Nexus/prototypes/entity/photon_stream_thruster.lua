...
----------------------------------------------------------------

  {
    ...
    max_health = 300,
    minable = {mining_time = 0.1, result = "photon-stream-thruster"},
    fast_replaceable_group = "photon-stream-thruster",
    ...
    min_performance = {fluid_volume = 0.1, fluid_usage = 0.05, effectivity = 1},
    max_performance = {fluid_volume = 0.8, fluid_usage = 0.1, effectivity = 0.51},
    fuel_fluid_box =
    {
      filter = "high-energetic-photonen-fluid",
