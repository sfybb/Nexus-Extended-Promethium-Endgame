...
-------OMEGA SUBSTATION-------

  {
	...
	--collision_box = {{-2.1, -2.5}, {1.9, 2.3}}, --old
    --selection_box = {{-2.1, -2.5}, {1.9, 2.3}}, --old
    ...
    {
      {
        shadow =
        {
          copper = util.by_pixel(136, 3),
          green = util.by_pixel(124, 8),
          red = util.by_pixel(151, 9)
        },
        wire =
        {
          copper = util.by_pixel(0, -52),
          green = util.by_pixel(-3, -56),
          red = util.by_pixel(3, -48)
        }
      },
    },
