...

{
    ...
    minable = {mining_time = 0.8, result = "atomar-assembler"},
    max_health = 600,
    ...
    {
      {
        ...
        volume = 1000,
        pipe_connections = {{ flow_direction="input", direction = defines.direction.west, position = {-4.85, 0} }},
...
--      }
    ...
    fast_replaceable_group = "atomar-assembler",
    --next_upgrade = "assembling-machine-2",
    circuit_wire_max_distance = assembling_machine_circuit_wire_max_distance,
    circuit_connector = circuit_connector_definitions["assembling-machine"],
    alert_icon_shift = util.by_pixel(0, -12),

    crafting_categories = {"atomar-assembler"},
    crafting_speed = 0.5,
    energy_source =
    {
      type = "electric",
    ...
    {
        animation = {
            filename = "__Nexus-Graphics__/graphics/entity/atomar-assembler.png",
            size = {512*2,512*2},
            shift = {0, 0},
	        scale = 0.35,
            line_length = 1,
        ...
        working_visualisations = {
            {
              animation = 
              {
                filename = "__Nexus-Graphics__/graphics/entity/atomar-assembler-animation.png",
                size = {512*2,512*2},
                shift = {0, 0},
	            scale = 0.35,
                line_length = 3,
    ...
    working_sound =
    {
    sound = {filename = "__space-age__/sound/entity/agricultural-tower/agricultural-tower-rotation-loop.ogg", volume = 0.7},
    apparent_volume = 0.4,
    }
},
