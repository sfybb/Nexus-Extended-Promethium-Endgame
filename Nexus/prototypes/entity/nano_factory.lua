...

{
    ...
    minable = {mining_time = 0.8, result = "nano-factory"},
    max_health = 600,
...
--      }
    ...
    fast_replaceable_group = "nano-factory",
    --next_upgrade = "assembling-machine-2",
    circuit_wire_max_distance = assembling_machine_circuit_wire_max_distance,
    circuit_connector = circuit_connector_definitions["assembling-machine"],
    alert_icon_shift = util.by_pixel(0, -12),

    crafting_categories = {"nano-factory"},
    crafting_speed = 1.0,
    energy_source =
    {
      type = "electric",
    ...
    {
        animation = {
            filename = "__Nexus-Graphics__/graphics/entity/nano-factory.png",
            size = {512,512},
            shift = {0, 0},
	        scale = 0.35,
            line_length = 1,
        ...
        working_visualisations = {
            {
              animation = 
              {
                filename = "__Nexus-Graphics__/graphics/entity/nano-factory-animation.png",
                size = {512,512},
                shift = {0, 0},
	            scale = 0.35,
                line_length = 4,
    ...
    working_sound =
    {
    sound = {filename = "__space-age__/sound/entity/rocket-turret/rocket-turret-rotation-loop.ogg", volume = 0.6},
    apparent_volume = 0.3,
    }
},
