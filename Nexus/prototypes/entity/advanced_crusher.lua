...

{
    ...
    minable = {mining_time = 0.8, result = "advanced-crusher"},
    max_health = 600,
...
--    fluid_boxes_off_when_no_fluid_recipe = true,
    ...
    fast_replaceable_group = "advanced_crusher",
    --next_upgrade = "assembling-machine-2",
    circuit_wire_max_distance = assembling_machine_circuit_wire_max_distance,
    circuit_connector = circuit_connector_definitions["assembling-machine"],
    alert_icon_shift = util.by_pixel(0, -12),

    crafting_categories = {"advanced-crusher"},
    crafting_speed = 1.0,
    energy_source =
    {
      type = "electric",
    ...
    {
        animation = {
            filename = "__Nexus-Graphics__/graphics/entity/advanced-crusher.png",
            size = {512,512},
            width = 512,
            height = 512,
            shift = {0,-0.2},
        ...
        working_visualisations = {
            {
              animation = 
              {
                filename = "__Nexus-Graphics__/graphics/entity/advanced-crusher-animation.png",
                size = {512,512},
                width = 512,
                height = 512,
                shift = {0,-0.2},
    ...
    working_sound =
    {
    sound = {filename = "__space-age__/sound/entity/crusher/crusher-loop.ogg", volume = 0.6},
    apparent_volume = 0.3,
    }
},
