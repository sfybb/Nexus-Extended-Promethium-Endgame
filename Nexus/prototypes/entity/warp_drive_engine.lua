--warp_drive_engine.lua

--Thruster Graphics and Animations are derived from ncc1702's Fusion Thruster mod
--which are in turn a kitbash from Wube Software's very own Space Age Expansion permission is granted explicitly via private discord message and implicitly through the MIT license
...
----------------------------------------------------------------

  {
    ...
    max_health = 4000,
    minable = {mining_time = 0.1, result = "warp-drive-engine"},
    fast_replaceable_group = "warp-drive-engine",
    ...
    min_performance = {fluid_volume = 0.1, fluid_usage = 0.2, effectivity = 1.0},
    max_performance = {fluid_volume = 0.8, fluid_usage = 0.2, effectivity = 1.0},
    fuel_fluid_box =
    {
      filter = "antimatter",
      ...
      pipe_connections =
      {
        {flow_direction = "input-output", direction = defines.direction.west, position = {-1, 0}, enable_working_visualisations = { "pipe-4" } },
        {flow_direction = "input-output", direction = defines.direction.east, position = { 1, 0}, enable_working_visualisations = { "pipe-1" } },
      }
    },
    oxidizer_fluid_box =
    {
      filter = "exotic-matter",
      ...
      pipe_connections =
      {
        {flow_direction = "input-output", direction = defines.direction.east, position = { 1,  2}, enable_working_visualisations = { "pipe-3" }},
        {flow_direction = "input-output", direction = defines.direction.west, position = {-1,  2}, enable_working_visualisations = { "pipe-2" }},
      }
    },
