...

{
    ...
    minable = {mining_time = 0.8, result = "photon-enrichment-chamber"},
    max_health = 600,
    ...
    fast_replaceable_group = "photon-enrichment-chamber",
    --next_upgrade = "assembling-machine-2",
    circuit_wire_max_distance = assembling_machine_circuit_wire_max_distance,
    circuit_connector = circuit_connector_definitions["assembling-machine"],
    alert_icon_shift = util.by_pixel(0, -12),

    crafting_categories = {"photon-enrichment-chamber"},
    crafting_speed = 0.5,
    energy_source =
    {
      type = "electric",
