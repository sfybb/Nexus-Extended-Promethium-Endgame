...
explosionEffect.name = "critical-photon-cube-explosion"
explosionEffect.localised_name = { "entity-name.critical-photon-cube-explosion" }
...
data.raw.item["critical-photon-cube"].spoil_ticks = 4 * minute
data.raw.item["critical-photon-cube"].spoil_to_trigger_result = {
  items_per_trigger = 1,
  trigger = {
      type = "direct",
      action_delivery =
